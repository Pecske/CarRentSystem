...
class RentController(ControllerBase):
    ...
    def save_or_update(self, dto: RentView) -> Wrapper[RentView]:
    ...
    def get_data_by_id(self, id: int) -> Wrapper[RentView]:
        result = Wrapper[RentView]()
        try:
    ...
    def get_all_data(self) -> Wrapper[list[RentView]]:
    ...
    def remove_data_by_id(self, id: int) -> Wrapper[RentView]:
        result = Wrapper[RentView]()
        try:
